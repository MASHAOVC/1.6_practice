...
let showMoreButton = document.querySelector('.show-more-element__devices');
let [icon, text] = showMoreButton.children;
let hiddenItems768 = document.querySelectorAll('.devices-list__list-item--hidden768');
let hiddenItems1100 = document.querySelectorAll('.devices-list__list-item--hidden1100');
